...
import net.dasdarklord.calculator.calcConstants.advancedReplacements
...
import net.dasdarklord.calculator.calcFunctions.userFunctions
...
class Lexer(val source: String) {
    ...
    fun lexTokens(): MutableList<Token> {
        ...
        if (replacementsEnabled) {
            for ((pattern, replaceWith) in net.dasdarklord.calculator.calcConstants.replacements) {
